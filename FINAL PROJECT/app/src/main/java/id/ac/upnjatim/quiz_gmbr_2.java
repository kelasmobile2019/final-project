...
public class quiz_gmbr_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_gmbr_2);

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("QuiZ Gambar - 3");
        ...
        button_cek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editText_jawab.getText().toString().equals(jawaban_benar)){
                    Toast.makeText(quiz_gmbr_2.this,"Yaa Benar!!!",Toast.LENGTH_SHORT).show();

                    Intent move_kuis_1 = new Intent(quiz_gmbr_2.this, quiz_gmbr_3.class);
                    startActivity(move_kuis_1);
                }
                else {
                    Toast.makeText(quiz_gmbr_2.this,"Yaa Salah!!!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
